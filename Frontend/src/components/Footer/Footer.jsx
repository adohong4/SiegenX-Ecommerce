        ...
        <>
            <footer className="footer">
                ...
                <div className="floating-buttons">
                    <a href="https://zalo.me/your_zalo_link" target="_blank" className="contact-button zalo">
                        <i className="fa-solid fa-comment"></i>
                    </a>
                    <a href="https://m.me/your_messenger_link" target="_blank" className="contact-button messenger">
